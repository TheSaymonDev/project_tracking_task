...
class _UpdateScreenState extends State<UpdateScreen> {
  ...
  void initState() {
    ...
    _projectUpdateController.text = widget.projectUpdate;
    _assignedEngineerController.text = widget.assignedEngineer;
    _assignedTechnicianController.text = widget.assignedTechnician;
    super.initState();
  }
  ...
  void _formOnSubmit() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      bool updateSuccess = await updateElementRequest(widget.id, _formValues);
